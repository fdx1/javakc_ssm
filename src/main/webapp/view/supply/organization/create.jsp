	...
	<script language="javaScript">
		$(function (){
			...
			$.post(root+'org/queryAllOrg.do',function (zNodes) {
				$.fn.zTree.init($("#org"), setting, zNodes);
			},'json')
		})
		...
		function onClick(e, treeId, treeNode) {
			var zTree = $.fn.zTree.getZTreeObj("org"),
	...
	<body>
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox float-e-margins">
				<form action="${path }/org/save.do" method="post" class="form-horizontal" role="form">
					<input type="hidden" id="oriPid" name="oriPid" value="" />
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input class="form-control" type="text"  name="oriOrder"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input class="form-control" type="text" name="oriLevel"/>
							</div>
						</div>
