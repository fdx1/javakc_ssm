	...
	<body>
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox float-e-margins">
				<form action="${path }/menu/update.do" method="post" class="form-horizontal" role="form">
                    ...
                    <fieldset>
						<legend>菜单基本信息</legend>
                       	<div class="form-group">
                          	...
                          	<div class="col-sm-10">
                            	<input class="form-control" id="menuname" name="menuName" value="${entity.menuName }" type="text" placeholder="填写菜单名称  测试查询"/>
                          	</div>
                       	</div>
                       	<div class="form-group">
                          	<label class="col-sm-2 control-label" for="menupid">选择父类</label>
                          	<div class="col-sm-10">
                            	<input class="form-control" id="menupidValue" name="menuPid" value="${entity.menuPid }" type="hidden"/>
                       	...
                       	<div class="form-group">
                          	...
                          	<div class="col-sm-10">
                            	<input class="form-control" id="menulevel" name="menuLevel" value="${entity.menuLevel }"readonly type="text" placeholder="自动填充菜单级别"/>
                          	</div>
                       	</div>
                       	<div class="form-group">
                          	<label class="col-sm-2 control-label" for="menuuri">访问路径</label>
                          	<div class="col-sm-10">
                            	<input class="form-control" id="menuuri" name="menuUri" type="text" value="${entity.menuUri }"placeholder="填写访问路径: test/query.do "/>
                          	</div>
                       	</div>
                       	<div class="form-group">
                          	<label class="col-sm-2 control-label" for="menupermission">访问权限</label>
                          	<div class="col-sm-10">
                            	<input class="form-control" id="menupermission" name="menuPermission" value="${entity.menuPermission }" type="text" placeholder="填写访问权限 test:query"/>
                          	</div>
                       	</div>
                       	<div class="form-group">
                          	<label class="col-sm-2 control-label" for="menuweight">菜单权重</label>
                          	<div class="col-sm-10">
                            	<input class="form-control" id="menuweight" name="menuWeight" value="${entity.menuWeight }" type="number" placeholder="填写菜单权重"/>
                          	</div>
                       	</div>
                       	<div class="form-group">
                          	...
                          	<div class="col-sm-10">
                          		<div class="switch switch-mini" >
                          			<input type="checkbox" name="menuState" ${entity.menuState==0?"checked":"" } value="0"
