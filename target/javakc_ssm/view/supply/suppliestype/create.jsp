		...
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox float-e-margins">
				<form action="${path }/type/save.do" method="post" class="form-horizontal" role="form">
                   <input type="hidden" id="typePid" name="typePid" value=""/>

                    <fieldset>
                        <legend>物资基本信息</legend>
						<div class="form-group">
							<a id="menuBtn"  href="#" onclick="showMenu(); return false;" class="col-sm-2 control-label">选择类别</a>
							<div class="col-sm-2">
								<input class="form-control" type="text" id="nodeName" name="nodeName" placeholder="请选择所属类别"/>
                       ...
                       <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input class="form-control" type="text" name="typeShort" />
							</div>
						</div>
                       ...
                       <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input class="form-control" type="text" name="typeOrder" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input class="form-control" type="text" name="typeLevel" />
							</div>
						</div>
