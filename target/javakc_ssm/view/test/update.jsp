		...
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox float-e-margins">
				<form action="${path }/test/update.do" method="post" class="form-horizontal" role="form">
					<input type="hidden" name="testId" id="testId" value="${testEntity.testId}">
                    <fieldset>
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-4">
                             <zhg:select codeTp="sex" name="testSex" cls="form-control" def="true" value="${testEntity.testSex}"></zhg:select>
                          </div>
                       </div>
                       <div class="form-group">
